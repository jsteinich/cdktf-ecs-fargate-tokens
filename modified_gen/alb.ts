...
import { TerraformStringSet, TerraformStringSetAttribute } from '../tf_attributes/terraform-string-set-attribute';
...
export interface AlbConfig extends cdktf.TerraformMetaArguments {
  ...
  readonly subnets?: TerraformStringSet;
...
export class Alb extends cdktf.TerraformResource {
  ...
  public constructor(scope: Construct, id: string, config: AlbConfig = {}) {
    ...
    this.putSubnets(config.subnets ?? new TerraformStringSetAttribute(this, 'subnets'));
  ...
  private _subnets!: TerraformStringSetAttribute;
  public get subnets(): TerraformStringSetAttribute {
    return this._subnets;
  }
  public putSubnets(value: TerraformStringSet | undefined) {
    if(value === undefined) {
      this._subnets.reset();
    }
    else {
      this._subnets = TerraformStringSetAttribute.Create(this, 'subnets', value);
    }
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      subnets: this._subnets.toTerraform(),
